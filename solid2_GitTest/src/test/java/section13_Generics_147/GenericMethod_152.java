...
class Valli{
	...
	//Here we are creating a generic method in the list 
	//using this generic method with the E
...
public class GenericMethod_152 {
		...
		// TODO Auto-generated method stub
			...
			stringList.add("Siva");
			stringList.add("Ram");
			stringList.add("Gurusamy");
			stringList.add("Yamaha");
			stringList.add("Rocket");
			Valli printString = new Valli();
